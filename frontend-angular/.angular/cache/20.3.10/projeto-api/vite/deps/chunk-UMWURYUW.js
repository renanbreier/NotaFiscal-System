...
var BaseView = class extends widget_default {
  ...
  _getSingleModeAriaLabel() {
    ...
    const formattedDate = date_default2.format(value, "date");
...
var MonthView = class extends calendar_base_view_default {
  ...
  getNavigatorCaption() {
    ...
    return `${date_default2.format(date, "monthandyear")}`;
  }
  _isTodayCell(cellDate) {
    const {
      _todayDate: today
  ...
  _getCellText(cellDate) {
    return `${date_default2.format(cellDate, "d")}`;
  }
  _getDayCaption(day) {
    const {
      colCount: daysInWeek
...
var YearView = class extends calendar_base_view_default {
  ...
  _getCellText(cellDate) {
    return date_default2.getMonthNames("abbreviated")[cellDate.getMonth()];
  }
  _getFirstCellData() {
    const {
      date: currentDate
  ...
  getNavigatorCaption() {
    ...
    return `${date_default2.format(date, "yyyy")}`;
  }
  isBoundary(date) {
...
var DecadeView = class extends calendar_base_view_default {
  ...
  _getCellText(cellDate) {
    return `${date_default2.format(cellDate, "yyyy")}`;
  }
  _getFirstCellData() {
...
var Calendar = class extends editor_default {
  ...
  _viewConfig(date) {
    const {
      firstDayOfWeek = date_default2.firstDayOfWeekIndex(),
      showWeekNumbers = false,
      selectWeekOnClick,
      weekNumberRule,
      zoomLevel = ZOOM_LEVEL.MONTH,
...
var DateBoxStrategy = class extends class_default.inherit({}) {
  ...
  getParsedText(text, format2) {
    const value = date_default2.parse(text, format2);
    return value || date_default2.parse(text);
  }
  renderInputMinMax() {
  }
  renderOpenedState() {
...
dateUtils.DATE_COMPONENTS_INFO = {
  ...
  month: {
    getter: "getMonth",
    setter: "setMonth",
    formatter: (value) => date_default2.getMonthNames()[value],
    startValue: 0,
    endValue: 11
  },
  hours: {
    getter: "getHours",
    setter: "setHours",
    formatter: (value) => date_default2.format(new Date(0, 0, 0, value), "hour"),
    startValue: 0,
    endValue: 23
  },
  minutes: {
    getter: "getMinutes",
    setter: "setMinutes",
    formatter: (value) => date_default2.format(new Date(0, 0, 0, 0, value), "minute"),
    startValue: 0,
    endValue: 59
  },
  seconds: {
    getter: "getSeconds",
    setter: "setSeconds",
    formatter: (value) => date_default2.format(new Date(0, 0, 0, 0, 0, value), "second"),
    startValue: 0,
    endValue: 59
  },
  milliseconds: {
    ...
    formatter: (value) => date_default2.format(new Date(0, 0, 0, 0, 0, 0, value), "millisecond"),
    startValue: 0,
    endValue: 999
  }
};
...
var DateBox = class extends m_drop_down_editor_default {
  ...
  _getDisplayedText(value) {
    ...
    if ("text" === mode) {
      ...
      displayedText = date_default2.format(value, displayFormat);
    } else {
      const format2 = this._getFormatByMode(mode);
      if (format2) {
        displayedText = date_default2.format(value, format2);
      } else {
...
var DateBoxMask = class extends m_date_box_base_default {
  ...
  _getFormatPattern() {
    ...
    if (isLDMLPattern) {
      ...
      this._formatPattern = getFormat2(((value) => date_default2.format(value, format2)));
    }
    return this._formatPattern;
  }
  _setNewDateIfEmpty() {
...
//# sourceMappingURL=chunk-UMWURYUW.js.map
