...
$stepper-step-optional-mark-font-size: $generic-xs-font-size !default;
$stepper-step-icon-size: $generic-base-icon-size !default;

$stepper-step-selected-font-weight: 400 !default;
