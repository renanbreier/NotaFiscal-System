...
$scheduler-time-indicator-color: getCustomVar(("$scheduler-time-indicator-color")) !default;
...
$scheduler-appointment-form-separator-color: $base-border-color !default;
