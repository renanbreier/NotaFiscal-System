...
$stepper-step-optional-mark-font-size: $material-xs-font-size !default;
$stepper-step-icon-size: $material-button-icon-size !default;

$stepper-step-selected-font-weight: 500 !default;
