...
class Popup extends _overlay.default {
    ...
    _renderTopToolbarImpl() {
        ...
        const items = this._getTopToolbarItems();
        const $toolbarContainer = (0, _renderer.default)("<div>").addClass("dx-popup-title").addClass(_constants.TOOLBAR_CLASS).insertBefore(this.$content());
    ...
    _renderBottomToolbarImpl() {
        ...
        const items = this._getToolbarItems("bottom");
        const $toolbarContainer = (0, _renderer.default)("<div>").addClass("dx-popup-bottom").addClass(_constants.TOOLBAR_CLASS).insertAfter(this.$content());
