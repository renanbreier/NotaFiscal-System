...
if (_devextremeQuill.default) {
    ...
    ToolbarModule = class extends _m_base.default {
        ...
        _createCommandMenuItem(command, text, commandOptions) {
            ...
            const options = (null === commandOptions || void 0 === commandOptions ? void 0 : commandOptions.map(_capitalize.capitalize)) ?? (null === (_getDefaultOptionsByC = (0, _ai.getDefaultOptionsByCommand)(command)) || void 0 === _getDefaultOptionsByC ? void 0 : _getDefaultOptionsByC.map(_capitalize.capitalize));
            const item = {
                id: command,
                name: command,
                ...
                items: null === options || void 0 === options ? void 0 : options.map((option => ({
                    ...
                    options: null === options || void 0 === options ? void 0 : options.map(_capitalize.capitalize)
                })))
            };
            return item
        }
        ...
        _prepareAIMenuItemConfig(item) {
            ...
            const {
                ...
                commands: commands = Object.keys(_ai.defaultCommandNames)
            } = item;
