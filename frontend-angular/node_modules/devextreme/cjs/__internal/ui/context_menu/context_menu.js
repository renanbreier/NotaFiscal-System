...
class ContextMenu extends _menu_base.default {
    ...
    _getItemsContainers() {
        var _this$_overlay2;
        return (null === (_this$_overlay2 = this._overlay) || void 0 === _this$_overlay2 ? void 0 : _this$_overlay2.$content().find(".dx-menu-items-container")) ?? (0, _renderer.default)()
    }
    ...
    _hideAllShownSubmenus() {
        var _this$_overlay6;
        const shownSubmenus = (0, _extend.extend)([], this._shownSubmenus);
        const $expandedItems = (null === (_this$_overlay6 = this._overlay) || void 0 === _this$_overlay6 ? void 0 : _this$_overlay6.$content().find(`.${DX_MENU_ITEM_EXPANDED_CLASS}`)) ?? (0, _renderer.default)();
        $expandedItems.removeClass(DX_MENU_ITEM_EXPANDED_CLASS);
    ...
    _show(event) {
        ...
        if (position) {
            ...
            const $subMenu = (0, _renderer.default)(null === (_this$_overlay7 = this._overlay) || void 0 === _this$_overlay7 ? void 0 : _this$_overlay7.content()).children(".dx-submenu");
    ...
    _renderItems(nodes, submenuContainer) {
        ...
        const $submenu = (0, _renderer.default)(null === (_this$_overlay9 = this._overlay) || void 0 === _this$_overlay9 ? void 0 : _this$_overlay9.content()).children(".dx-submenu");
        if ($submenu.length) {
            this._initScrollable($submenu)
        }
    }
