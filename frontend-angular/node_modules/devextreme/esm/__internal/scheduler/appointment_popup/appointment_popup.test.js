...
describe("Appointment popup form", (() => {
    ...
    it("Original appointment's fields shouldn't fill if used fieldExpr", (async () => {
        ...
        expect(null === (_newAppointment = newAppointment) || void 0 === _newAppointment ? void 0 : _newAppointment.Subject).toBe("qwerty");
        expect(null === (_newAppointment2 = newAppointment) || void 0 === _newAppointment2 ? void 0 : _newAppointment2.text).toBeUndefined();
    ...
    it("onAppointmentFormOpening event should pass e.popup argument", (async () => {
        ...
        expect(null === (_POM$popup$getTitle = POM.popup.getTitle()) || void 0 === _POM$popup$getTitle ? void 0 : _POM$popup$getTitle.textContent).toBe("Information")
    }));
    ...
    it("Appointment popup should work properly", (async () => {
        ...
        expect(POM.popup.getInputByLabel("Subject").value).toBe("NEW SUBJECT");
        expect(POM.getPopups().length).toBe(1);
        POM.popup.getDoneButton().click();
        ...
        expect(dataItem.text).toBe("NEW SUBJECT");
        const appointmentR = POM.getAppointment("recurrent-app");
        if (null !== appointmentR && void 0 !== appointmentR && appointmentR.element) {
            appointmentR.element.click()
        } else {
            throw new Error('Appointment "recurrent-app" not found or has no element')
        }
        jest.runAllTimers();
        null === (_POM$getTooltipAppoin2 = POM.getTooltipAppointment()) || void 0 === _POM$getTooltipAppoin2 || _POM$getTooltipAppoin2.click();
        POM.popup.getEditSeriesButton().click();
        expect(POM.popup.getSwitchByName("repeat").value).toBe("true");
        expect(POM.popup.getInputByLabel("Subject").value).toBe("recurrent-app")
    }));
